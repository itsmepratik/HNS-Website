            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <div className="h-48 rounded-lg bg-black overflow-hidden relative border border-white/10 group">
                  <img src="https://www.myjeepcompass.com/attachments/no-sludge-jpg.15201/" className="w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-all duration-500" alt="Clean Oil" />
                ...
                <p className="text-xs text-center text-emerald-400 font-mono">OPTIMAL LUBRICATION</p>
              </div>
              <div className="space-y-2">
                <div className="h-48 rounded-lg bg-black overflow-hidden relative border border-red-500/30 group">
                  <img src="https://d2hucwwplm5rxi.cloudfront.net/wp-content/uploads/2023/06/16124130/clean-engine-sludge-body-a-160620230532-1024x640.jpg" className="w-full h-full object-cover opacity-80 group-hover:scale-110 transition-transform duration-700" alt="Dirty Sludge" />
                ...
                <p className="text-xs text-center text-red-400 font-mono">DIRTY ENGINE</p>
              </div>
            </div>
          </div>
