...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const sizes = {
    ...
    md: "px-5 py-2.5 text-sm md:px-6 md:py-2.5",
    lg: "px-6 py-3 text-sm md:px-8 md:py-3.5 md:text-base",
    xl: "px-8 py-3.5 text-base md:px-10 md:py-4 md:text-lg"
  };
