...
export const About: React.FC = () => {
  ...
  useGSAP(
    () => {
      ...
      tl.from(".about-badge", { y: -20, opacity: 0, duration: 1 })
        .from(
          ".about-title",
          { y: 50, opacity: 0, duration: 1.2, skewY: 5 },
          "-=0.8",
        )
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen pt-24 pb-12 bg-[#020202] relative overflow-hidden"
    >
      ...
      <Section className="relative z-10">
        ...
        <div className="max-w-5xl mx-auto text-center mb-32 relative">
          ...
          <h1 className="about-title text-[clamp(3.5rem,8vw,6rem)] font-display font-black text-white mb-8 leading-[0.9] tracking-tighter uppercase">
            THE{" "}
              ...
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 group">
                ...
                <div className="absolute bottom-6 left-6 z-20">
                  <div className="px-4 py-2 bg-black/80 backdrop-blur-md border border-brand-500/30 rounded-lg">
                    <p className="text-brand-500 text-[0.9375rem] font-mono uppercase tracking-widest">
                      The Founder
                    </p>
                  </div>
                </div>
            ...
            <div className="md:col-span-7 founder-content">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-brand-500 font-mono text-[0.9375rem] uppercase tracking-widest">
                    Saham, Oman
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 border-t border-white/5 pt-8">
                {[
                  ...
                  <div key={i}>
                    <p className="text-3xl font-black text-white mb-1 font-mono">
                      {stat.val}
                    </p>
                    <p className="text-[0.9375rem] text-neutral-500 uppercase tracking-wider">
                      {stat.label}
                    </p>
                  </div>
                ))}
            ...
            <div className="son-card group">
              <div className="relative h-full bg-[#080808] border border-white/10 rounded-3xl p-8 hover:border-brand-500/30 transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex justify-between items-start mb-8">
                    ...
                    <div className="text-right">
                      <div className="inline-block px-3 py-1 bg-white/5 rounded-full border border-white/10 mb-2">
                        <span className="text-[0.9375rem] text-brand-500 font-mono uppercase tracking-widest">
                          Operations
                        </span>
                      </div>
                      <p className="text-[0.9375rem] text-neutral-500 font-mono uppercase">
                        Sohar University
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="text-brand-500 text-[0.9375rem] font-mono uppercase tracking-widest mb-6">
                    {t("about.rifat_role")}
                  </p>
                  ...
                  <div className="pt-6 border-t border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[0.9375rem] text-neutral-500 font-mono uppercase tracking-wider">
                        Active Leadership
                      </span>
                    </div>
                    <Fingerprint
              ...
              <div className="relative h-full bg-[#080808] border border-white/10 rounded-3xl p-8 hover:border-blue-500/30 transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex justify-between items-start mb-8">
                    ...
                    <div className="text-right">
                      <div className="inline-block px-3 py-1 bg-white/5 rounded-full border border-white/10 mb-2">
                        <span className="text-[0.9375rem] text-blue-400 font-mono uppercase tracking-widest">
                          Strategy
                        </span>
                      </div>
                      <p className="text-[0.9375rem] text-neutral-500 font-mono uppercase">
                  ...
                  <p className="text-blue-400 text-[0.9375rem] font-mono uppercase tracking-widest mb-6">
                    {t("about.ashiq_role")}
                  </p>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {["Saham", "Sohar", "Muscat", "International"].map((loc, i) => (
                  <span
                    key={i}
                    className="px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-[0.9375rem] font-mono uppercase tracking-widest text-neutral-400 hover:text-white hover:border-brand-500/50 transition-colors cursor-default"
                  >
                    {loc}
                  </span>
                ))}
        ...
        <div className="border-t border-white/5 pt-32">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <p className="text-[0.9375rem] font-mono text-neutral-500 uppercase tracking-widest mb-8">
              ...
              <div className="flex flex-wrap justify-center gap-12 md:gap-20 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                <div className="flex flex-col items-center gap-2 group">
                  <Award
                    size={48}
                    className="text-white group-hover:text-brand-500 transition-colors"
                  />
                  <span className="text-[0.9375rem] font-bold text-neutral-400">
                    Best Service 2023
                  </span>
                </div>
                <div className="flex flex-col items-center gap-2 group">
              ...
              {[
                {
                  ...
                  text: t("authority.review1"),
                },
                {
                  name: "Mike T.",
                  role: "Fleet Manager",
                  text: t("authority.review2"),
                },
                {
                  name: "David L.",
                  role: "Car Enthusiast",
                  text: t("authority.review3"),
                },
              ].map((review, i) => (
                <div
                  key={i}
                  className="bg-white/5 border border-white/5 p-8 rounded-2xl relative hover:border-brand-500/30 transition-colors"
                >
                  ...
                  <p className="text-neutral-300 mb-6 leading-relaxed relative z-10 text-[0.9375rem]">
                    "{review.text}"
                  </p>
