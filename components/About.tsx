...
import { GraduationCap, Globe, TrendingUp, Users, MapPin, Award, Briefcase, Activity, Hexagon, Fingerprint, ShieldCheck, Star, Quote } from 'lucide-react';
    ...
    <div ref={containerRef} className="min-h-screen pt-24 pb-12 bg-[#020202] relative overflow-hidden">
      ...
      <Section className="relative z-10">
        ...
        <div className="max-w-5xl mx-auto text-center mb-32 relative">
           <div className="about-badge inline-flex items-center gap-3 px-5 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md text-white/80 text-xs font-mono tracking-[0.3em] uppercase mb-8 shadow-2xl">
                 ...
                 <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 group">
                    ...
                    <div className="absolute bottom-6 left-6 z-20">
                       <div className="px-4 py-2 bg-black/80 backdrop-blur-md border border-brand-500/30 rounded-lg">
                          <p className="text-brand-500 text-[10px] font-mono uppercase tracking-widest">The Founder</p>
                       </div>
                    </div>
                 </div>
              ...
              <div className="md:col-span-7 founder-content">
                 <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                       ...
                       <p className="text-brand-500 font-mono text-xs uppercase tracking-widest">Saham, Oman</p>
                    </div>
                 </div>
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                       <div className="flex justify-between items-start mb-8">
                          ...
                          <div className="text-right">
                             <div className="inline-block px-3 py-1 bg-white/5 rounded-full border border-white/10 mb-2">
                                <span className="text-[10px] text-brand-500 font-mono uppercase tracking-widest">Operations</span>
                             </div>
                             <p className="text-xs text-neutral-500 font-mono uppercase">Sohar University</p>
                          </div>
                       </div>
                       
                       <h3 className="text-3xl font-bold text-white mb-2">{t('about.rifat_name')}</h3>
                       <p className="text-brand-500 text-xs font-mono uppercase tracking-widest mb-6">{t('about.rifat_role')}</p>
                       ...
                       <div className="pt-6 border-t border-white/5 flex items-center justify-between">
                          <div className="flex items-center gap-2">
                             ...
                             <span className="text-xs text-neutral-500 font-mono uppercase tracking-wider">Active Leadership</span>
                          </div>
                 ...
                 <div className="relative h-full bg-[#080808] border border-white/10 rounded-3xl p-8 hover:border-blue-500/30 transition-all duration-500 hover:-translate-y-2">
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                       <div className="flex justify-between items-start mb-8">
                          ...
                          <div className="text-right">
                             <div className="inline-block px-3 py-1 bg-white/5 rounded-full border border-white/10 mb-2">
                                <span className="text-[10px] text-blue-400 font-mono uppercase tracking-widest">Strategy</span>
                             </div>
                             <p className="text-xs text-neutral-500 font-mono uppercase">Spain</p>
                          </div>
                       </div>
                       
                       <h3 className="text-3xl font-bold text-white mb-2">{t('about.ashiq_name')}</h3>
                       <p className="text-blue-400 text-xs font-mono uppercase tracking-widest mb-6">{t('about.ashiq_role')}</p>
                       ...
                       <div className="pt-6 border-t border-white/5 flex items-center justify-between">
                          <div className="flex items-center gap-2">
                             ...
                             <span className="text-xs text-neutral-500 font-mono uppercase tracking-wider">Global Insight</span>
                          </div>
                          <Fingerprint className="text-neutral-700" size={32} strokeWidth={1} />
                       </div>
                    </div>
              ...
              <div className="relative z-10">
                 ...
                 <div className="flex flex-wrap justify-center gap-4">
                    {['Saham', 'Sohar', 'Muscat', 'International'].map((loc, i) => (
                       <span key={i} className="px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-xs font-mono uppercase tracking-widest text-neutral-400 hover:text-white hover:border-brand-500/50 transition-colors cursor-default">
                          {loc}
                       </span>
                    ))}
                 </div>
        ...
        <div className="border-t border-white/5 pt-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="text-center mb-20">
                    <p className="text-sm font-mono text-neutral-500 uppercase tracking-widest mb-8">Recognized Excellence</p>
                    <div className="flex flex-wrap justify-center gap-12 md:gap-20 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                         <div className="flex flex-col items-center gap-2 group">
                            <Award size={48} className="text-white group-hover:text-brand-500 transition-colors" />
                            <span className="text-xs font-bold text-neutral-400">Best Service 2023</span>
                         </div>
                         <div className="flex flex-col items-center gap-2 group">
                            <ShieldCheck size={48} className="text-white group-hover:text-brand-500 transition-colors" />
                            <span className="text-xs font-bold text-neutral-400">ISO 9001 Certified</span>
                         </div>
                         <div className="flex flex-col items-center gap-2 group">
                            <Star size={48} className="text-white group-hover:text-brand-500 transition-colors" />
                            <span className="text-xs font-bold text-neutral-400">5-Star Rated</span>
                         </div>
                    </div>
                </div>
                     ...
                     {[
                       ...
                       { name: "David L.", role: "Car Enthusiast", text: t('authority.review3') }
                        ...
                        <div key={i} className="bg-white/5 border border-white/5 p-8 rounded-2xl relative hover:border-brand-500/30 transition-colors">
                          ...
                          <p className="text-neutral-300 mb-6 leading-relaxed relative z-10 text-sm">"{review.text}"</p>
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-white font-bold text-sm border border-white/10 shadow-lg">
