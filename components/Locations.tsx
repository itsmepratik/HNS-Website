             ...
             <div className="absolute top-4 left-4 right-4 lg:hidden z-10">
                 <div className="bg-black/80 backdrop-blur-md p-4 rounded-xl border border-white/10 shadow-lg">
                    <div className="flex items-center justify-between">
                       ...
                       <span className="text-xs text-brand-500 font-mono bg-brand-500/10 px-2 py-1 rounded">Open Now</span>
                    </div>
                 </div>
             </div>
               ...
               <div className="location-info-content relative z-10 h-full flex flex-col">
                  <div>
                    <div className="inline-flex items-center gap-2 mb-6 px-3 py-1 rounded-full bg-white/5 border border-white/10">
                       ...
                       <span className="text-[10px] text-neutral-400 font-mono uppercase tracking-widest">Active Location</span>
                    </div>

                    <h2 className="text-4xl font-bold text-white mb-2">{activeLocation.name}</h2>
                    <p className="text-neutral-500 text-sm mb-10">Premium Service Center</p>

                    <div className="space-y-8">
                        <div>
                           <h3 className="text-brand-500 font-mono text-xs uppercase tracking-widest mb-3 flex items-center gap-2">
                        ...
                        <div>
                           ...
                           <div className="flex justify-between text-sm">
                              ...
                              <span className="text-white">2:00 PM - 9:00 PM</span>
                           </div>
                        </div>
                    </div>
                  </div>
